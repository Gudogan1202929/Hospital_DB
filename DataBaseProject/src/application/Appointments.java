...
public class Appointments {
	...
	public Appointments(int pateint_ID, int doctor_ID, int secretaries_ID, String patient_Name,
	...
	public Appointments(int appointments_ID, int pateint_ID, int doctor_ID, int secretaries_ID,
			String patient_Name, String doctor_Name, String secretaries_Name, String dateApponitments, String time) {
		super();
	...
	public Appointments(int appointments_ID, int pateint_ID, int doctor_ID, int secretaries_ID,
		 String dateApponitments, String time) {
		super();
		this.appointments_ID = appointments_ID;
		this.pateint_ID = pateint_ID;
		this.doctor_ID = doctor_ID;

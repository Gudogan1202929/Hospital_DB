...
public class Diagnosis {
	...
	public Diagnosis(int diagnosis_ID, int pateint_ID, String pateint_name, String diagnosis_description,
			String treatment_discription, int doctor_ID, String dateOfBirth) {
		super();
		this.diagnosis_ID = diagnosis_ID;
		this.treatment_discription = treatment_discription;
		this.diagnosis_description = diagnosis_description;
